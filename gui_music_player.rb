...
class MusicPlayerMain < Gosu::Window
  ...
  def draw_stuff()
    ...
    x2 = 60
    while i < 15
      draw_quad(690,x1, @background ,1000,x1, @background ,690,x2,@background ,1000,x2, @background , ZOrder::PLAYER)
      x1+=35
      x2+=35
      draw_quad(690,x1, @background3 ,1000,x1, @background3 ,690,x2,@background3 ,1000,x2, @background3 , ZOrder::PLAYER)
      x1+=35
      x2+=35
      i+=1
    end
